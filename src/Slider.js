              ...
              <div class="block wow fadeInUp" data-wow-delay=".3s">
                <section class="cd-intro">
                  <h1
                    ...
                    data-wow-delay=".4s"
                  >
                    <span>HI, Asad Saeed &amp; I AM A</span>
                    <br />
                ...
                <h2 class="wow fadeInUp animated" data-wow-delay=".6s">
                  ...
                  <br /> web designer and developer. This site showcases some of
                  my work.
                </h2>
                <a
                  class="btn-lines dark light wow fadeInUp animated btn btn-default btn-green hvr-bounce-to-right"
                  data-wow-delay=".9s"
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-sm-6">
              <div
                class="block wow fadeInLeft"
                data-wow-delay=".3s"
                data-wow-duration="500ms"
              >
                <h2>ABOUT ME</h2>
                <p>
                  Hello, I’m a UI/UX Designer &amp; Front End Developer from
