      ...
      <section id="service-page" class="pages service-page">
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <h2
                class="subtitle wow fadeInUp animated"
                data-wow-delay=".3s"
              ...
              <p
                class="subtitle-des wow fadeInUp animated"
                data-wow-delay=".5s"
                data-wow-duration="500ms"
              >
                ...
                <div class="row service-parts">
                  <div class="col-md-6">
                    ...
                    >
                      ...
                      <h4>BRANDING</h4>
                      <p>
                        Veritatis eligendi, dignissimos. Porta fermentum mus
                        aute pulvinar earum minus platea massa feugiat rutrum
                        urna facilisi ipsameum.
                      </p>
                    </div>
                  </div>
                  <div class="col-md-6">
      ...
      <section id="clients">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2
                class="subtitle text-center wow fadeInUp animated"
                data-wow-duration="500ms"
                data-wow-delay=".3s"
              >
                Our Happy Clinets
              ...
              <p
                class="subtitle-des text-center wow fadeInUp animated"
                data-wow-duration="500ms"
                data-wow-delay=".5s"
              >
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              ...
              <div id="clients-logo" class="clients-logo-slider">
                <img
                  ...
                  src="images/clients/logo-1.jpg"
                  alt=""
                />
                <img
                  class="img-fluid mx-2"
                  src="images/clients/logo-2.jpg"
                  alt=""
                />
                <img
                  class="img-fluid mx-2"
                  src="images/clients/logo-3.jpg"
                  alt=""
                />
                <img
                  class="img-fluid mx-2"
                  src="images/clients/logo-4.jpg"
                  alt=""
                />
                <img
                  class="img-fluid mx-2"
                  src="images/clients/logo-5.jpg"
                  alt=""
                />
                <img
                  class="img-fluid mx-2"
            ...
            <div class="col-md-12">
              <div class="block">
                ...
                >
                  ...
                  Nobis,
                  <br />
                  possimus commodi, fugiat magnam temporibus vero magni
                  recusandae? Dolore, maxime praesentium.
                </p>
                <a
                  href="contact.html"
